:-assert(activity_schema(
	...
	[		[move(_G969,_G1041),[[throughout(premanipulationarea(_G969)),throughout(premanipulationarea(_G1041)),throughout(tablepremanipulationarea(_G5431,_G1041))]-[]]],
			...
			[pick(_G1249,_G1176),[[at_start(objectat(_G1169,_G1176)),at_start(objectat(_G1249,_G1176)),throughout(placingarea(_G1176)),throughout(tableplacingarea(_G5431,_G1176))]-[]]],
			[place(_G1249,_G1220),[[throughout(tray(_G1220))]-[]]],
			...
			[pick(_G1169,_G1220),[[throughout(tray(_G1220))]-[]]],
			[place(_G1169,_G1600),[[at_goal(objectat(_G1169,_G1600)),at_goal(objectat(_G1249,_G1600)),throughout(placingarea(_G1600)),throughout(tableplacingarea(_G5432,_G1600))]-[]]]	],
