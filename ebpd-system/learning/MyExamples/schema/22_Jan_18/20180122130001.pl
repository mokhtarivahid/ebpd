:-assert(activity_schema(
	...
	[		[unstack(_G925,_G968,_G975,_G939),[[at_goal(in(_G968,_G2387)),at_goal(in(_G975,_G2387)),at_goal(top(_G968,_G2387)),at_start(empty(_G925)),at_start(in(_G968,_G939)),at_start(in(_G975,_G939)),at_start(top(_G968,_G939)),throughout(blue(_G968)),throughout(blue(_G975)),throughout(pile(_G939))]-[]]],
			...
			[put(_G925,_G1127,_G932),[[at_goal(in(_G1127,_G2387)),at_start(empty(_G925)),at_start(in(_G1127,_G939)),throughout(blue(_G1127)),throughout(table(_G932))]-[]]],
			[unstack(_G925,_G1279,_G1431,_G939),[[at_goal(in(_G1279,_G2387)),at_goal(in(_G1431,_G2387)),at_start(empty(_G925)),at_start(in(_G1279,_G939)),at_start(in(_G1431,_G939)),throughout(blue(_G1279)),throughout(blue(_G1431)),throughout(pile(_G939))]-[]]],
			...
			[put(_G925,_G1735,_G932),[[at_goal(in(_G1735,_G2387)),at_start(empty(_G925)),at_start(in(_G1735,_G939)),throughout(red(_G1735)),throughout(table(_G932))]-[]]],
			[unstack(_G925,_G1887,_G2039,_G939),[[at_goal(in(_G1887,_G2387)),at_goal(in(_G2039,_G2387)),at_start(empty(_G925)),at_start(in(_G1887,_G939)),at_start(in(_G2039,_G939)),throughout(pile(_G939)),throughout(red(_G1887)),throughout(red(_G2039))]-[]]],
			...
			[stack(_G925,_G1127,_G1887,_G2387),[[at_goal(in(_G1127,_G2387)),at_goal(in(_G1887,_G2387)),at_start(empty(_G925)),at_start(in(_G1127,_G939)),at_start(in(_G1887,_G939)),throughout(blue(_G1127)),throughout(pile(_G2387)),throughout(red(_G1887))]-[]]],
			[pick(_G925,_G1735,_G932),[[at_goal(in(_G1735,_G2387)),at_start(empty(_G925)),at_start(in(_G1735,_G939)),throughout(red(_G1735)),throughout(table(_G932))]-[]]],
			[stack(_G925,_G1735,_G1127,_G2387),[[at_goal(in(_G1127,_G2387)),at_goal(in(_G1735,_G2387)),at_start(empty(_G925)),at_start(in(_G1127,_G939)),at_start(in(_G1735,_G939)),throughout(blue(_G1127)),throughout(pile(_G2387)),throughout(red(_G1735))]-[]]],
			[pick(_G925,_G975,_G932),[[at_goal(in(_G975,_G2387)),at_start(empty(_G925)),at_start(in(_G975,_G939)),throughout(blue(_G975)),throughout(table(_G932))]-[]]],
