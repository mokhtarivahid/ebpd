:-assert(activity_schema(
	...
	[		[pick(_G653,_G732,_G703),[[at_goal(in(_G732,_G667)),at_start(empty(_G653)),at_start(ontable(_G732,_G703)),throughout(red(_G732)),throughout(table(_G703))]-[]]],
			...
			[pick(_G653,_G1340,_G703),[[at_goal(in(_G1340,_G667)),at_start(empty(_G653)),at_start(ontable(_G1340,_G703)),throughout(red(_G1340)),throughout(table(_G703))]-[]]],
			[stack(_G653,_G1340,_G1188,_G667),[[at_goal(in(_G1188,_G667)),at_goal(in(_G1340,_G667)),at_start(empty(_G653)),at_start(ontable(_G1188,_G703)),at_start(ontable(_G1340,_G703)),throughout(blue(_G1188)),throughout(pile(_G667)),throughout(red(_G1340))]-[]]],
			[pick(_G653,_G1492,_G703),[[at_goal(in(_G1492,_G667)),at_start(empty(_G653)),at_start(ontable(_G1492,_G703)),throughout(blue(_G1492)),throughout(table(_G703))]-[]]],
			[stack(_G653,_G1492,_G1340,_G667),[[at_goal(in(_G1340,_G667)),at_goal(in(_G1492,_G667)),at_start(empty(_G653)),at_start(ontable(_G1340,_G703)),at_start(ontable(_G1492,_G703)),throughout(blue(_G1492)),throughout(pile(_G667)),throughout(red(_G1340))]-[]]],
			[pick(_G653,_G1644,_G703),[[at_goal(in(_G1644,_G667)),at_start(empty(_G653)),at_start(ontable(_G1644,_G703)),throughout(red(_G1644)),throughout(table(_G703))]-[]]],
			[stack(_G653,_G1644,_G1492,_G667),[[at_goal(in(_G1492,_G667)),at_goal(in(_G1644,_G667)),at_start(empty(_G653)),at_start(ontable(_G1492,_G703)),at_start(ontable(_G1644,_G703)),throughout(blue(_G1492)),throughout(pile(_G667)),throughout(red(_G1644))]-[]]],
			[pick(_G653,_G1796,_G703),[[at_goal(in(_G1796,_G667)),at_start(empty(_G653)),at_start(ontable(_G1796,_G703)),throughout(blue(_G1796)),throughout(table(_G703))]-[]]],
			[stack(_G653,_G1796,_G1644,_G667),[[at_goal(in(_G1644,_G667)),at_goal(in(_G1796,_G667)),at_start(empty(_G653)),at_start(ontable(_G1644,_G703)),at_start(ontable(_G1796,_G703)),throughout(blue(_G1796)),throughout(pile(_G667)),throughout(red(_G1644))]-[]]],
	...
	[top(_G12257,_G660),top(_G2100,_G667),in(_G732,_G667),in(_G1036,_G667),in(_G1340,_G667),in(_G1644,_G667),in(_G1948,_G667),in(_G884,_G667),in(_G1188,_G667),in(_G1492,_G667),in(_G1796,_G667),in(_G2100,_G667),on(_G732,_G811),on(_G884,_G732),on(_G1036,_G884),on(_G1188,_G1036),on(_G1340,_G1188),on(_G1492,_G1340),on(_G1644,_G1492),on(_G1796,_G1644),on(_G1948,_G1796),on(_G2100,_G1948)]
)).
