:-assert(robot_activity_experience(
  ...
  [
    ...
    [
        move(h1,t1,p1,l1),
        unstack(h1,b5,b10,p1,l1),
        move(h1,p1,t1,l1),
        putdown(h1,b5,t1,l1),
        move(h1,t1,p1,l1),
        unstack(h1,b10,b4,p1,l1),
        move(h1,p1,t1,l1),
        putdown(h1,b10,t1,l1),
        move(h1,p1,t1,l1),
        unstack(h1,b4,b9,p1,l1),
        move(h1,p1,t1,l1),
        putdown(h1,b4,t1,l1),
        move(h1,t1,p1,l1),
        unstack(h1,b9,b3,p1,l1),
        move(h1,p1,t1,l1),
        putdown(h1,b9,t1,l1),
        move(h1,t1,p1,l1),
        unstack(h1,b3,b8,p1,l1),
        move(h1,p1,t1,l1),
        putdown(h1,b3,t1,l1),
        move(h1,t1,p1,l1),
        unstack(h1,b8,b2,p1,l1),
        move(h1,p1,t1,l1),
        putdown(h1,b8,t1,l1),
        move(h1,t1,p1,l1),
        unstack(h1,b2,b7,p1,l1),
        move(h1,p1,t1,l1),
        putdown(h1,b2,t1,l1),
        move(h1,t1,p1,l1),
        unstack(h1,b7,b1,p1,l1),
        move(h1,p1,t1,l1),
        putdown(h1,b7,t1,l1),
        move(h1,t1,p1,l1),
        unstack(h1,b1,b6,p1,l1),
        move(h1,p1,t1,l1),
        putdown(h1,b1,t1,l1),
        move(h1,t1,p1,l1),
        unstack(h1,b6,pallet1,p1,l1),
        move(h1,p1,t1,l1),
        putdown(h1,b6,t1,l1),
        pickup(h1,b1,t1,l1),
        move(h1,t1,p2,l1),
