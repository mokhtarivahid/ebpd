...
:- assert(
 ...
 problem_solution(cranfield,
  ...
  [
    ...
    assemble_component(sony_scara,gp_3,p_o1,cranf_p1,lock_pin,
         cranfield_benchmark,fix_1),
    pick_part_from_pallet(sony_scara,gp_3,p_o2,lock_pin,pal_2,pal_sys),
    assemble_component(sony_scara,gp_3,p_o2,cranf_p2,lock_pin,
         cranfield_benchmark,fix_1),
    ...
    assemble_component(sony_scara,gp_3,p_o6,cranf_p5,lock_pin,
         cranfield_benchmark,fix_1),
    pick_part_from_pallet(sony_scara,gp_3,p_o7,lock_pin,pal_2,pal_sys),
    assemble_component(sony_scara,gp_3,p_o7,cranf_p4,lock_pin,
         cranfield_benchmark,fix_1),
    pick_part_from_pallet(sony_scara,gp_3,p_o8,lock_pin,pal_2,pal_sys),
    assemble_component(sony_scara,gp_3,p_o8,cranf_p3,lock_pin,
         cranfield_benchmark,fix_1),
    store_tool(sony_scara,gp_3,toolp_3)
