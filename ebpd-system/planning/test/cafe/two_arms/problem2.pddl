...
(:init
    ...
    (robotarmposture leftarm armuntucked)
    (robotarmposture rightarm armuntucked)

    ;; belonging torso posture
    (robottorsoposture pr2 torsoup)
...
(:goal
  (and
    ...
    (objectat mug3 placingareaeastrightcounter1)
    (objectat mug4 placingareaeastrightcounter1)
    (objectat mug5 placingareaeastrightcounter1)
    (objectat mug6 placingareaeastrightcounter1)
)))
